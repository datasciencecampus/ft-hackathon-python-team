# Code of conduct for `hackathon`

Contributors to this repository hosted by `FinTrans` are expected to follow the
...
- "Project", we mean this `hackathon` GitHub repository;
- "Maintainer", we mean the `FinTrans` organisation owners; and
- "Leadership", we mean both `FinTrans` organisation owners, line managers, and other
...
[Iasmina.Ursul@ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:Iasmina.Ursul@ons.gov.uk
